<?php
/* -----------------------------------------------------------------------------------------
   $Id: send_order.php 12470 2019-12-09 13:17:25Z GTB $
...
if ($_SESSION['customer_id'] == $order_check['customers_id'] || $send_by_admin) { // Send Order by Admin
  ...
  // revocation to email 
  /* BOF - Auskommentiert, da separat per PDF-Anhang 
  ...
  // AGB und Widerruf anhängen
  $path_to_attachement = DIR_FS_DOCUMENT_ROOT . 'media/Allgemeine_Geschaeftsbedingungen_ascasa.pdf';
  $path_to_more_attachements[] = DIR_FS_DOCUMENT_ROOT . 'media/Widerrufsbelehrung_ascasa.pdf';
  $path_to_more_attachements[] = DIR_FS_DOCUMENT_ROOT . 'media/Allgemeine_Geschaeftsbedingungen_5-Jahres-Garantie.pdf';
