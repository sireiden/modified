<?php
/* --------------------------------------------------------------
   $Id: new_product.php 12294 2019-10-23 09:15:59Z GTB $
  ...
  <div class="main pdg2 flt-l"><?php echo sprintf($text_new_or_edit,$breadcrumb_html); ?></div>
    <div class="clear div_box mrg5">
      ...
      <div style="float:left;width:43%; vertical-align:top">
        <table class="tableInput border0">
          ...
          <?php echo xtc_draw_hidden_field('shipping_status_old', $pInfo->products_shippingtime); ?>
          <tr>
    ...
    /* BOF
     * Auto-Include disabled, da die Sachen einzeln eingebunden werden sollen
     * 
    ...
    // Individuelle Ascasa Optionen
    require(DIR_FS_ADMIN.'includes/extra/modules/new_product/product_fields.php');
    
    // Produkt-Tabs
    require(DIR_FS_ADMIN.'includes/extra/modules/new_product/product_tabs_head.php');
    ...
    <?php 
    // Produkt-Tabs
    require(DIR_FS_ADMIN.'includes/extra/modules/new_product/product_tabs_content.php');
    ?>    
    ...
    <?php 
    // Zubehörartikel
    require(DIR_FS_ADMIN.'includes/extra/modules/new_product/product_attachments.php');    
    ?>      
