...
define($prefix.'SORT_ORDER_DESC', 'Reihenfolge der Anzeige. Kleinste Ziffer wird zuerst angezeigt.<br>Achten Sie bitte darauf das sich der Wert nicht mit einem anderen Modul deckt, da sonst eins der beiden Module ggf. nicht angezeigt wird.');
...
define($prefix.'REUSE_CARD', 'm&ouml;chten Sie folgende Kreditkarte wieder verwenden?');
define($prefix.'REUSE_CARD_NUMBER', 'KartenNr: ');
define($prefix.'REUSE_CARD_TEXT', 'Ja, Ich m&ouml;chte die Karte erneut verwenden.');
define($prefix.'WILLUSE_CARD', 'folgende Kreditkarte wird wieder verwendet.<br>KartenNr: ');
define($prefix.'DATA_SAVED', 'Ihre Daten wurden &uuml;bertragen.<br>Bitte fahren Sie mit der Bestellung fort.<br>');
