<?php
/* -----------------------------------------------------------------------------------------
   $Id: metatags.php 12432 2019-12-02 07:08:21Z GTB $
  ...
  switch(basename($PHP_SELF)) {
    ...
    case FILENAME_MANUFACTURERS_PAGE :
        $manufacturers_page_query = "select page_meta_title, page_meta_description, page_meta_keywords FROM " . TABLE_MANUFACTURERS_PAGES . " WHERE manufacturers_id = '".(int)$_GET['manufacturers_id']."' and page_id = '".(int)$_GET['manufacturers_page']."'";
        ...
        $metadata_array = array(
            'title' => $manufacturers_page['page_meta_title'],
            'description' => $manufacturers_page['page_meta_description'],
            'keywords' => $manufacturers_page['page_meta_keywords'],
            'link' => xtc_href_link(seo_url_href_mask($manufacturers['manufacturers_name']) . '/' .  seo_url_href_mask($manufacturers_page['page_title']).MAN_OVERVIEW_DIVIDER.$manufacturers['id'].PAG_DIVIDER.$manufacturers_page['page_id'].'.html'),
            'robot' => '',
        );
        $metadata_array['title'] .= ' - ' . ML_META_TITLE;
