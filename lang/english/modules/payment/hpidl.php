...
define($prefix.'MODULE_MODE_DESC', 'AFTER: Paymentinformations will be entered after process with DEBIT function.<br>NOWPF: The paymentinformations will be entered in Shop as usual and the Customer will be redirected to bank after sending the order.');
...
define($prefix.'ACCOUTNUMBER', 'Account No. :');
define($prefix.'ACCOUNTBANK', 'Bank :');
define($prefix.'ACCOUTOWNER', 'Account holder :');
define($prefix.'ACCOUTCOUNTRY', 'Country :');
