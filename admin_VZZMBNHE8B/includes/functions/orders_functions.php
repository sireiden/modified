<?php
/* -----------------------------------------------------------------------------------------
   $Id: orders_functions.php 12050 2019-07-30 16:40:45Z GTB $
  ...
  function orders_address_edit($oID, $data_array) {
    ...
    $sql_data_array = array(
      ...
      'customers_telephone' => xtc_db_prepare_input($data_array['customers_telephone']),
        'customers_telephone_optional' => xtc_db_prepare_input($data_array['customers_telephone_optional']),
      ...
      'kvnummer' => xtc_db_prepare_input($data_array['kvnummer']),
      'last_modified' => 'now()'
    );
