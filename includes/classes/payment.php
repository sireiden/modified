<?php
/* -----------------------------------------------------------------------------------------
   $Id: payment.php 12439 2019-12-02 17:40:51Z GTB $
  ...
  class payment {
    ...
    function javascript_validation() {
      ...
      if (is_array($this->modules)) {
        ...
        $js .= "\n" . '  if (!document.getElementById("checkout_payment").conditions_warranty.checked) {' . "\n" .
            '    error_message = error_message + unescape("* Sofern Sie allgemeinen Gesch%E4ftsbedingungen zur 5 Jahres Garantie nicht bestätigen, k%F6nnen wir Ihre Bestellung bedauerlicherweise nicht entgegennehmen!\n\n");' . "\n\n" .
            '    error = 1;' . "\n\n" .
            '  }' . "\n\n";
        /*  EOF AGB zur 5-Jahres-Garantie */
        
        /*  BOF Weitergabe personenbezogener Daten an Versanddienstleister */
        $js .= "\n" . '  if (!document.getElementById("checkout_payment").conditions_shipping.checked) {' . "\n" .
            '    error_message = error_message + unescape("* Sofern Sie die Weitergabe Ihrer E-Mail-Adresse bzw. Telefonnummer an Versanddienstleister zur Bestellabwicklung nicht akzeptieren, können wir Ihre Bestellung bedauerlicherweise nicht entgegennehmen!");' . "\n\n" .
            '    error = 1;' . "\n\n" .
            '  }' . "\n\n";
