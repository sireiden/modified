<?php
/* -----------------------------------------------------------------------------------------
   $Id: xtc_wysiwyg.inc.php 11991 2019-07-23 07:54:32Z GTB $
...
function xtc_wysiwyg($type, $lang, $langID = '',$addonType='') 
{
    ...
    switch($type) {
        ...
        case 'manufacturers_description':
            ...
            $default_editor_height = 400;
            break;
        case 'main_promotions_description':
            $editorName = 'main_promotions_description';
            $default_editor_height = 400;
            break;
        case 'page_text':
            $editorName = 'page_text['.$langID.']';
            $default_editor_height = 400;
            break;
        case 'tab_text':
            $editorName = 'tab_text['.$langID.']';
            $default_editor_height = 400;
            break;
        ...
        // Schnellbearbeitung von Einträgen
        case 'products_quick_edit':
            $editorName = 'products_description';
            $default_editor_height = 600;
            break;
            
        // Schnellbearbeitung von Einträgen
        case 'megamenu_text':
            $editorName = 'megamenu_text';
            $default_editor_height = 400;
            break;
    }
...
function editorJSLink($js_src)
{
    ...
    if (!isset ($editorJSLinkCache)) {
      $editorJSLinkCache =  PHP_EOL . '<script type="text/javascript" src="'.$js_src.'"charset="utf-8"></script>' . PHP_EOL;
    } else {
      $editorJSLinkCache = '';
    }
