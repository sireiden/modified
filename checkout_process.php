<?php
/* -----------------------------------------------------------------------------------------
   $Id: checkout_process.php 12201 2019-09-27 07:22:44Z Tomcraft $
...
if (isset($_SESSION['tmp_oID']) && is_numeric($_SESSION['tmp_oID'])) {
  ...
  //BOF zusätzliche Informationen in der Bestellung
  $sql_data_array['referer'] = $_SESSION['tracking']['http_referer']['host'].$_SESSION['tracking']['http_referer']['path'];
  $sql_data_array['templateset'] = 'modified2';
  $sql_data_array['customers_telephone_optional'] = $order->customer['telephone_optional'];
  $sql_data_array['contact_bewertung'] = $_SESSION['contact_bewertung'];
  //EOF zusätzliche Informationen in der Bestellung
