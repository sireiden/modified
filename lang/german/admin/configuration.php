<?php
/* -----------------------------------------------------------------------------------------
   $Id: configuration.php 12454 2019-12-03 15:52:02Z Tomcraft $
...
// GLOSSAR / LEXIKON
define('MODULE_LEXIKON_STATUS_TITLE' , 'Lexikon / Enzyklop&auml;die aktivieren');
define('MODULE_LEXIKON_STATUS_DESC' , 'Aktivieren Sie das Modul, wenn Sie die Lexikonfunktion in Ihrem Shop nutzen m&ouml;chten. Die Fachbegriffe werden auf der Produktdetailseite rot hervorgehoben und mit einem kleinen Icon versehen oder einfach verlinkt. Beim Klick auf das Icon erscheint ein neues Fenster oder Acronym, wo der Fachbegriff erklärt wird.');
define('MODULE_LEXIKON_TYPE_TITLE' , 'Lexikon / Enzyklop&auml;die Arbeitsweise');
define('MODULE_LEXIKON_TYPE_DESC' , '<b>PopUp</b> - &Ouml;ffnet ein neues Fenster mit Begriffserkl&auml;rung, <br> <b>Acronym</b> - Setzt ein HTML-Tag');

// Finanzierungsmodul
define('COMMERZFINANZ_MINIMUM_PRICE_TITLE_TITLE', 'Mindestpreis');
define('COMMERZFINANZ_MINIMUM_PRICE_TITLE_DESC', 'Geben Sie bitte den Artikelmindestpreis an (Beispiel: 500.00)');
define('COMMERZFINANZ_MAXIMUM_PRICE_TITLE_TITLE', 'Maximalpreis');
define('COMMERZFINANZ_MAXIMUM_PRICE_TITLE_DESC', 'Geben Sie bitte die maximale Finanzierungssumme an (Beispiel: 50000.00)');
define('COMMERZFINANZ_ZINS_EFF_TITLE', 'Zinssatz');
define('COMMERZFINANZ_ZINS_EFF_DESC', 'Bitte geben Sie den Zinssatz f&uuml;r die Beispielrechnung ohne % ein  (Beispiel: 9.9)');
define('COMMERZFINANZ_STATUS_TITLE', 'Commerz Finanz GmbH Finanzierungsbeispiel ein / ausschalten');
define('COMMERZFINANZ_STATUS_DESC', 'ein / ausschalten');

define('COMMERZFINANZ_ZINS_EFF_6_TITLE', 'Zinssatz 6 Monate');
define('COMMERZFINANZ_ZINS_EFF_6_DESC', 'Bitte geben Sie den Zinssatz f&uuml;r die 6 monatige Rate ohne % ein  (Beispiel: 9.9)');
define('COMMERZFINANZ_STATUS_TITLE', 'Commerz Finanz GmbH Finanzierungsbeispiel ein / ausschalten');
define('COMMERZFINANZ_STATUS_DESC', 'ein / ausschalten');
define('COMMERZFINANZ_SOLLZINS_6_TITLE', 'Sollzins 6 Monate');
define('COMMERZFINANZ_SOLLZINS_6_DESC', 'Bitte geben Sie den Sollzins f&uuml;r die Beispielrechnung ohne % ein  (Beispiel: 2.62)');
define('COMMERZFINANZ_ZINS_EFF_12_TITLE', 'Zinssatz 12 Monate');
define('COMMERZFINANZ_ZINS_EFF_12_DESC', 'Bitte geben Sie den Zinssatz f&uuml;r die 12 monatige Rate ohne % ein  (Beispiel: 9.9)');
define('COMMERZFINANZ_SOLLZINS_12_TITLE', 'Sollzins 12 Monate');
define('COMMERZFINANZ_SOLLZINS_12_DESC', 'Bitte geben Sie den Sollzins f&uuml;r die Beispielrechnung ohne % ein  (Beispiel: 5.75)');
define('COMMERZFINANZ_ZINS_EFF_18_TITLE', 'Zinssatz 18 Monate');
define('COMMERZFINANZ_ZINS_EFF_18_DESC', 'Bitte geben Sie den Zinssatz f&uuml;r die 18 monatige Rate ohne % ein  (Beispiel: 9.9)');
define('COMMERZFINANZ_SOLLZINS_18_TITLE', 'Sollzins 18 Monate');
define('COMMERZFINANZ_SOLLZINS_18_DESC', 'Bitte geben Sie den Sollzins f&uuml;r die Beispielrechnung ohne % ein  (Beispiel: 6.54)');
define('COMMERZFINANZ_ZINS_EFF_24_TITLE', 'Zinssatz 24 Monate');
define('COMMERZFINANZ_ZINS_EFF_24_DESC', 'Bitte geben Sie den Zinssatz f&uuml;r die 24 monatige Rate ohne % ein  (Beispiel: 9.9)');
define('COMMERZFINANZ_SOLLZINS_24_TITLE', 'Sollzins 24 Monate');
define('COMMERZFINANZ_SOLLZINS_24_DESC', 'Bitte geben Sie den Sollzins f&uuml;r die Beispielrechnung ohne % ein  (Beispiel: 6.90)');
define('COMMERZFINANZ_ZINS_EFF_30_TITLE', 'Zinssatz 30 Monate');
define('COMMERZFINANZ_ZINS_EFF_30_DESC', 'Bitte geben Sie den Zinssatz f&uuml;r die 30 monatige Rate ohne % ein  (Beispiel: 9.9)');
define('COMMERZFINANZ_SOLLZINS_30_TITLE', 'Sollzins 30 Monate');
define('COMMERZFINANZ_SOLLZINS_30_DESC', 'Bitte geben Sie den Sollzins f&uuml;r die Beispielrechnung ohne % ein  (Beispiel: 7.09)');
define('COMMERZFINANZ_ZINS_EFF_36_TITLE', 'Zinssatz 36 Monate');
define('COMMERZFINANZ_ZINS_EFF_36_DESC', 'Bitte geben Sie den Zinssatz f&uuml;r die 36 monatige Rate ohne % ein  (Beispiel: 9.9)');
define('COMMERZFINANZ_SOLLZINS_36_TITLE', 'Sollzins 36 Monate');
define('COMMERZFINANZ_SOLLZINS_36_DESC', 'Bitte geben Sie den Sollzins f&uuml;r die Beispielrechnung ohne % ein  (Beispiel: 7.46)');
define('COMMERZFINANZ_ZINS_EFF_42_TITLE', 'Zinssatz 42 Monate');
define('COMMERZFINANZ_ZINS_EFF_42_DESC', 'Bitte geben Sie den Zinssatz f&uuml;r die 42 monatige Rate ohne % ein  (Beispiel: 9.9)');
define('COMMERZFINANZ_SOLLZINS_42_TITLE', 'Sollzins 42 Monate');
define('COMMERZFINANZ_SOLLZINS_42_DESC', 'Bitte geben Sie den Sollzins f&uuml;r die Beispielrechnung ohne % ein  (Beispiel: 7.73)');
define('COMMERZFINANZ_ZINS_EFF_48_TITLE', 'Zinssatz 48 Monate');
define('COMMERZFINANZ_ZINS_EFF_48_DESC', 'Bitte geben Sie den Zinssatz f&uuml;r die 48 monatige Rate ohne % ein  (Beispiel: 9.9)');
define('COMMERZFINANZ_SOLLZINS_48_TITLE', 'Sollzins 48 Monate');
define('COMMERZFINANZ_SOLLZINS_48_DESC', 'Bitte geben Sie den Sollzins f&uuml;r die Beispielrechnung ohne % ein  (Beispiel: 7.93)');
define('COMMERZFINANZ_ZINS_EFF_54_TITLE', 'Zinssatz 54 Monate');
define('COMMERZFINANZ_ZINS_EFF_54_DESC', 'Bitte geben Sie den Zinssatz f&uuml;r die 54 monatige Rate ohne % ein  (Beispiel: 9.9)');
define('COMMERZFINANZ_SOLLZINS_54_TITLE', 'Sollzins 54 Monate');
define('COMMERZFINANZ_SOLLZINS_54_DESC', 'Bitte geben Sie den Sollzins f&uuml;r die Beispielrechnung ohne % ein  (Beispiel: 8.08)');
define('COMMERZFINANZ_ZINS_EFF_60_TITLE', 'Zinssatz 60 Monate');
define('COMMERZFINANZ_ZINS_EFF_60_DESC', 'Bitte geben Sie den Zinssatz f&uuml;r die 60 monatige Rate ohne % ein  (Beispiel: 9.9)');
define('COMMERZFINANZ_SOLLZINS_60_TITLE', 'Sollzins 60 Monate');
define('COMMERZFINANZ_SOLLZINS_60_DESC', 'Bitte geben Sie den Sollzins f&uuml;r die Beispielrechnung ohne % ein  (Beispiel: 8.21)');
define('COMMERZFINANZ_ZINS_EFF_66_TITLE', 'Zinssatz 66 Monate');
define('COMMERZFINANZ_ZINS_EFF_66_DESC', 'Bitte geben Sie den Zinssatz f&uuml;r die 66 monatige Rate ohne % ein  (Beispiel: 9.9)');
define('COMMERZFINANZ_SOLLZINS_66_TITLE', 'Sollzins 66 Monate');
define('COMMERZFINANZ_SOLLZINS_66_DESC', 'Bitte geben Sie den Sollzins f&uuml;r die Beispielrechnung ohne % ein  (Beispiel: 8.31)');
define('COMMERZFINANZ_ZINS_EFF_72_TITLE', 'Zinssatz 72 Monate');
define('COMMERZFINANZ_ZINS_EFF_72_DESC', 'Bitte geben Sie den Zinssatz f&uuml;r die 72 monatige Rate ohne % ein  (Beispiel: 9.9)');
define('COMMERZFINANZ_SOLLZINS_72_TITLE', 'Sollzins 72 Monate');
define('COMMERZFINANZ_SOLLZINS_72_DESC', 'Bitte geben Sie den Sollzins f&uuml;r die Beispielrechnung ohne % ein  (Beispiel: 8.40)');
define('COMMERZFINANZ_MANUFACTURERS_TITLE', 'Für diese Hersteller wird die Zahlung per Finanzierung angeboten');
define('COMMERZFINANZ_MANUFACTURERS_DESC', 'kommagetrennte Eingabe der IDs');
