<?php
 /*-------------------------------------------------------------
   $Id: orders_info_blocks.php 12204 2019-09-28 08:08:39Z GTB $
...
?>
      ...
      <div class="div_box mrg5">
          ...
          <tr>
            <td valign="top" style="border-right: 1px solid #a3a3a3;">
              <table width="100%" border="0" cellspacing="0" cellpadding="2">
                ...
                <tr>
                  <td class="main"><b>Telefon alternativ</b></td>
                  <td class="main"><?php echo $order->customer['telephone_optional']; ?></td>
                </tr>                
                <tr>                
        ...
        <table cellspacing="0" cellpadding="2" class="table">
          ...
          $get_names_query=xtc_db_query("SELECT id, title, mail_text FROM ".TABLE_MAIL_TEMPLATES." order by id");
          while($get_names=xtc_db_fetch_array($get_names_query)){
              $mail_template[]=array('id' => $get_names['id'],'text' => $get_names['title']);
          }
          ?>
          <tr>
            <td class="main"><b><div><b>Vorlage:</b> <?php echo xtc_draw_pull_down_menu('mail_template', $mail_template, '', 'id="mail_template"')?></td>
          </tr>                     
          <tr>
            <td class="main"><?php echo xtc_draw_textarea_field('comments', 'soft', '60', '8', ''); ?></td>
          </tr>
         <tr>
            <td class="main"><b><div><b>Als Vorlage speichern unter:</b> <?php echo xtc_draw_input_field('mail_template_title', '', 'maxlength="100" style="width:250px"') ?></td>
          </tr>           
          <tr>
            ...
            <td>
              <table border="0" cellspacing="0" cellpadding="2">
                <tr>
                  ...
                  <td class="main" style="width:40px;"><?php echo xtc_draw_checkbox_field('notify', '', false); ?></td>
                </tr>
                <tr>  
                  <td class="main"><b><?php echo ENTRY_NOTIFY_COMMENTS; ?></b></td>
                  <td class="main" style="width:40px;"><?php echo xtc_draw_checkbox_field('notify_comments', '', false); ?></td>
                </tr>
                <tr>              
                  <td class="main"><b>AGB an E-Mail Anhängen</b></td>
                  <td class="main"><?php echo xtc_draw_checkbox_field('notify_add_agb', '', false); ?></td>
                </tr>
                <tr>              
                  <td class="main"><b>AGB zur 5 Jahres Garantie an E-Mail Anhängen</b></td>
                  <td class="main"><?php echo xtc_draw_checkbox_field('notify_add_warranty', '', false); ?></td>
                </tr> 
                <tr>              
                  <td class="main"><b>Widerrufsbelehrung an E-Mail Anhängen</b></td>
                  <td class="main"><?php echo xtc_draw_checkbox_field('notify_add_revocation', '', false); ?></td>
                </tr>
                <tr>              
                  <td class="main"><b>Batterieverordnung an E-Mail Anhängen</b></td>
                  <td class="main"><?php echo xtc_draw_checkbox_field('notify_add_battery', '', false); ?></td>
                </tr>
              </table>
            ...
            <td>
              ...
              <div class="flt-r"> 
                ...
                */ ?>
                ...
                ?>
                <a class="button" target="_blank" id="invoice_link" href="<?php echo xtc_href_link(FILENAME_PRINT_ORDER,'oID='.$oID); ?>"><?php echo BUTTON_INVOICE; ?></a>
                <a class="button" target="_blank" id="invoice_link" href="<?php echo xtc_href_link(FILENAME_PRINT_ORDER,'oID='.$oID.'&version=proforma_de'); ?>">Proforma Rechnung Deutsch</a>
                <a class="button" target="_blank" id="invoice_link" href="<?php echo xtc_href_link(FILENAME_PRINT_ORDER,'oID='.$oID.'&version=proforma_en'); ?>">Proforma Rechnung Englisch</a>
