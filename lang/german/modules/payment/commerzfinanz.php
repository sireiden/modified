...
define('MODULE_PAYMENT_COMMERZFINANZ_TEXT_DESCRIPTION', 'Consors Finanzierung');
...
define('MODULE_PAYMENT_COMMERZFINANZ_STATUS_DESC' , 'M&ouml;chten Sie Zahlungen per Consors Finanzierung Finanz akzeptieren?');
define('MODULE_PAYMENT_COMMERZFINANZ_NUMBER_TITLE' , 'Commerz Finanz GmbH Haendlernummer');
define('MODULE_PAYMENT_COMMERZFINANZ_NUMBER_DESC' , 'Geben Sie hier Ihre Haendlernummer der Consors Finanzierung ein');
