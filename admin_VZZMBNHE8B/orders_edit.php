<?php
/* --------------------------------------------------------------
   $Id: orders_edit.php 12047 2019-07-30 16:09:04Z GTB $
   ...
   v.1.32 - 2012-05-23 (c) by web28 - www.rpa-com.de: Korrektur fï¿½r Nettosumme bei Modulen ohne Steuersatz
   ...
   v.1.26 - 2011-11-01 (c) by web28 - www.rpa-com.de: Lï¿½nderwechsel -> delivery_country_iso_code_2, billing_country_iso_code_2
...
<body>
  ...
  <table class="tableBody">
    <tr>
      ...
      ?>
      <?php 
      // BOF - Nachträgliches Bearbeiten einer Bestellung, wenn die Rechnung schon gedruckt ist, soll nicht mehr möglich sein
      ...
      <!-- body_text_eof //-->
       <?php 
      // Erneuter Rechnungsausdruck soll nicht möglich sein 
      }
      else {
      ?>
      <td class="boxCenter">
          <table border="0" width="100%">
    		<tr>
    			<td class="main"><h1>Die Rechnung f&uuml;r diese Bestellung wurde schon erstellt. Bearbeiten ist daher nicht mehr m&ouml;glich</h1>
    			<br><a class="button" href="<?php echo xtc_href_link(FILENAME_ORDERS, 'action=edit&oID='.(int)$_GET['oID'])?>">Zur&uuml;ck</a></td>
    		</tr>
    	  </table> 
      </td>
      <?php     
