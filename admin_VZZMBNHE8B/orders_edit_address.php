<?php
  /* --------------------------------------------------------------
   $Id: orders_edit_address.php 10495 2016-12-13 16:11:46Z GTB $
...
<table class="tableBoxCenter collapse">
  ...
  <tr class="dataTableRow">
    ...
    <td class="dataTableContent" colspan="3">
    <?php echo xtc_draw_input_field('customers_telephone_optional', $order->customer['telephone_optional'], 'style="width: 200px"');?>
    </td>
  </tr> 
  <tr class="dataTableRow">
    <td class="dataTableContent">
  ...
  <tr class="dataTableRow">
    ...
    <td class="dataTableContent" colspan="3">
    <?php echo xtc_draw_input_field('kvnummer', $order->customer['kvnummer'], 'style="width: 200px"');?>
    </td>
  </tr>   
  <tr class="dataTableRow">
