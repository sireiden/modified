<?php
/* -----------------------------------------------------------------------------------------
   $Id: main.php 12418 2019-11-18 08:04:56Z GTB $
...
class main {
  ...
  function getProductPopupLink($pID, $text, $class = '', $add_params = '') {
    ...
    if ($class == 'image') {
      ...
      $productPopupLink = '<a target="_blank" href="'.xtc_href_link('product_info.php', 'products_id='.$pID.$link_parameters, $request_type).'" >'.'<img class="'.$class.'" alt="" src="'.$products_image.'" />'.'</a>';
    } else {
      ...
      $productPopupLink = '<a target="_blank" href="'.xtc_href_link('product_info.php', 'products_id='.$pID.$add_params.$add_params, $request_type).'" class="'.$class.'">'.$text.'</a>';
    }
