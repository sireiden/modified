...
// CSV-Export
if($action == 'export') {
       $csv_schema = 'Best.Datum;Best-Nr.;Kommission;Bestellstatus;Hersteller;Anzahl/Menge;Artikel;Artikelnummer;Herstellartikelnummer;EAN;VK brutto;Steuersatz;Tr.K;NN/Paypal;Skonto;Idealo Direktkauf ID; Gesamtsumme Bestellung;Zahl-Art;Lieferland;Bestell. Liefer.;Sachbearb. ;AB;Kunden-; Hersteller- und Liefer-Hinweise;;;;;Link zur Bewertungsabgabe'."\n";
    ...
    while($data=xtc_db_fetch_array($result)) {
        ...
        if($data['contact_bewertung'] != 1 && $data['orders_id'] > 430864) {
        ...
        $order_status = get_order_status($data['orders_status']);
        ...
        while($products_data=xtc_db_fetch_array($products_result)) {
            ...
            $products_details = get_product_details($products_data['products_id']);
            ...
            if($i == 1) {
                $csv_content .=  $order_date.';'.
                    ...
                    $products_details['products_manufacturers_model'].';'.
                    $products_details['products_ean'].';'.	
                    number_format($products_data['final_price'],2,',','.').';'.
                    number_format($products_data['products_tax'],2,',','.').';'.
                    $tr_costs.';'.
                    $ot_costs.';'.
                    $cash_discount.';'.
                    $idealo_order_id.';'.
    ...
    header("Content-Disposition: attachment; filename=CSV-Rendite.csv");
      ...
      <td class="boxCenter">
        ...
        <div class="flt-l">
          ...
          <div class="main pdg2 flt-l">
			CSV aller Shopbestellungen (ohne Kundengruppe ascasa Küchenstudio) für die Renditeanalyse erstellen;      
          </div>
        </div>
        <div class="clear div_box brd-none">
          <div class="pageHeading mrg5">Klicken Sie auf "CSV-Datei erstellen" um die Datei für die Renditeanalyse zu erstellen</div>
          <div class="div_box mrg5"><b>Bitte beachten Sie Beim erstellen der Datei folgendes:<br>
                ...
                <?php echo xtc_draw_form('export',FILENAME_CSV_YIELD,'action=export','post','enctype="multipart/form-data"'); ?>
                <div class="mrg5">  			
                Startdatum: 
