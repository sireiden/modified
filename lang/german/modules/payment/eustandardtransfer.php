...
/* -----------------------------------------------------------------------------------------
  ...
  define('MODULE_PAYMENT_EUSTANDARDTRANSFER_STATUS_TITLE','Vorkasse Modul aktivieren');
  define('MODULE_PAYMENT_EUSTANDARDTRANSFER_STATUS_TITLE', 'Vorkasse Transfer Modul aktivieren');
