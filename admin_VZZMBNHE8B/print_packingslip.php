<?php
  /* -----------------------------------------------------------------------------------------
   $Id: print_packingslip.php 11999 2019-07-24 10:15:08Z GTB $
  ...
  $smarty->assign('telephone', $order->customer['telephone']);
  $smarty->assign('telephone_optional', $order->customer['telephone_optional']);
