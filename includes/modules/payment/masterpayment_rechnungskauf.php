 ...
 * ----------------------------------------------------
 *
 * $Id: masterpayment_rechnungskauf.php 11575 2019-03-21 09:12:10Z GTB $
 *	
 *	The Modul based on:
...
require_once(DIR_FS_CATALOG . 'includes/external/masterpayment/MasterpaymentActions.class.php');
  ...
  class masterpayment_rechnungskauf extends MasterpaymentActions {
    ...
    function __construct() {
      ...
      $this->sort_order = ((defined('MODULE_PAYMENT_MASTERPAYMENT_RECHNUNGSKAUF_SORT_ORDER')) ? MODULE_PAYMENT_MASTERPAYMENT_RECHNUNGSKAUF_SORT_ORDER : '');
      $this->enabled = ((defined('MODULE_PAYMENT_MASTERPAYMENT_RECHNUNGSKAUF_STATUS') && MODULE_PAYMENT_MASTERPAYMENT_RECHNUNGSKAUF_STATUS == 'True') ? true : false);
