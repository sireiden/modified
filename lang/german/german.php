<?php
/* -----------------------------------------------------------------------------------------
   $Id: german.php 12421 2019-11-26 16:30:18Z AGI $
...
define('IMAGE_BUTTON_SPECIALREQUEST', 'Sonderpreis anfragen');
...
define('TXT_PER',' pro ');
define('TAX_INFO_INCL','inkl. %s USt.');
...
// GLOSSAR / LEXIKON
define('TEXT_DISPLAY_NUMBER_OF_LINKS', 'Zeige <b>%d</b> bis <b>%d</b> (von insgesamt <b>%d</b>)');
define('TEXT_ITEMS_PER_PAGE','Artikel pro Seite: ');
define('TEXT_LEXIKON_NO_RECORDS','Keine Eintr&auml;ge...');
define('TEXT_LEXIKON_NO_RECORDS_DESC','Es existieren keine Eintr&auml;ge zu diesem Buchstaben.');
define('TEXT_LEXIKON_ALL','Alle');
// GLOSSAR / LEXIKON

// BOF Commerz-Finanz Modul
define('COMMERZFINANZ_DESC', '<div class="fs85" style="color: #b20000;">schon ab %s mtl.</div><div class="fs85 commerz-finanz-listing">bei einer maximalen Laufzeit von %s Monaten;<br /> Gesamtbetrag %s;<br /> Gebundener j&auml;hrl. Sollzinssatz %s%%<br /> eff. Jahreszins %s%%.<br />Diese Angaben stellen zugleich das repräsentative Beispiel im Sinne des § 6a PangV dar.<br />Vermittlung erfolgt ausschließlich für die Commerz Finanz GmbH, Schwanthalerstr. 31, 80336 München.</div>');
define('COMMERZFINANZ_DESC_1','<strong>Ihre Vorteile auf einem Blick:</strong><br /><br /><strong>Schnell:</strong> Sofortige Warenauslieferung nach Eingang des Antrags bei unserer Partnerbank<sup class="fs85">1, 2</sup><br /><strong>G&uuml;nstig:</strong>  Gebundener j&auml;hrlicher Sollzinssatz %s%%;<br /><strong>Flexibel:</strong> Individuelle Raten und Laufzeiten<br /><strong>Sicher:</strong> Auf Wunsch pers&ouml;nliches Sorglos-Paket<sup class="fs85">3</sup> zu Ihrer finanziellen Absicherung<br /><br />');
define('COMMERZFINANZ_DESC_2', '<sup class="fs85">2</sup> Vorbehaltlich einer abschliessenden positiven Pr&uuml;fung nach Eingang Ihrer Unterlagen.</span><br /><sup class="fs85">3</sup> Das Sorglos-Paket bietet Versicherungsschutz gegen verschiedene Risiken durch Aufnahme in eine Gruppenversicherung. Der Versicherer &uuml;bernimmt die Raten bei unverschuldeter Arbeitslosigkeit, Arbeitsunf&auml;higkeit oder im Todesfall. Einzelheiten entnehmen Sie bitte den Allgemeinen Versicherungsbedingungen.</span><br /><a href="'.xtc_href_link(FILENAME_CONTENT, 'coID=10').'">Weitere Details zur Finanzierung</a>');
define('COMMERZFINANZ_SUCCESS', '<div style="text-align: center; color: #b20000; font-size:120%">Um Ihre Bestellung weiter bearbeiten zu k&ouml;nnen werden Sie zur Commerz Finanz weiter geleitet. KLicken Sie hierzu auf den "weiter" Link. Der Finanzierungsantrag auf den Seiten der Commerz Finanz öffnet sich in einem neuen Fenster.<br /></div>');
define('COMMERZFINANZ_HEAD','<br /><strong>M&ouml;gliche Laufzeiten:</strong>');
define('COMMERZFINANZ_MONATE', 'Laufzeit<br />(Monate)');
define('COMMERZFINANZ_JAHRESZINS','Effektiver<br /> Jahreszins');
define('COMMERZFINANZ_LAUFZEIT_MONATRATE','Monatliche Rate');
define('COMMERZFINANZ_SOLLZINS','Gebundener<br /> j&auml;hrl. Sollzinssatz');
define('COMMERZFINANZ_RATENFAKTOR', 'Ratenfaktor');
define('COMMERZFINANZ_TOTAL', 'Gesamtbetrag');
define('COMMERZFINANZ_DESC_SHORT', '<br /><div class="commer-finanz-listingshort" title="0&#37; - Finanzierung"><img src="/images/finanzierung_0prozent.gif" border="0" alt="0&#37;"><br />Finanzierung schon<br /> ab %s mtl.<br /><a href="%s" rel="nofollow" target="_blank" class="iframe cboxElement" title="Informationen zum Ratenkauf" style="font-weight:normal"><span style="text-decoration:underline;color:#fd8701">Informationen zum Ratenkauf</span></a></div>');
define('COMMERZFINANZ_DESC_LONG', '<div id="finanzierungsinfo" style="display:none;" class="fs85 commerz-finanz-listing"><p>bei einer maximalen Laufzeit von %s Monaten;<br /> Gesamtbetrag %s;<br /> Gebundener j&auml;hrl. Sollzinssatz %s%%<br /> eff. Jahreszins %s%%.<br />Diese Angaben stellen zugleich das repräsentative Beispiel im Sinne des § 6a PangV dar.<br />Vermittlung erfolgt ausschließlich für die Commerz Finanz GmbH, Schwanthalerstr. 31, 80336 München.</p></div>');
