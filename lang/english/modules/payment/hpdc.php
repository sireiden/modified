...
define($prefix.'TEXT_TITLE', 'Debitcard');
define($prefix.'TEXT_DESC', 'Debitcard over Heidelberger Payment GmbH');
...
define($prefix.'REUSE_CARD', 'do you want to use the following debitcard again ?');
define($prefix.'REUSE_CARD_NUMBER', 'CardNo: ');
define($prefix.'REUSE_CARD_TEXT', 'Yes, I want to reuse the card again.');
define($prefix.'WILLUSE_CARD', 'the following debitcard will be used again.<br>CardNo: ');
