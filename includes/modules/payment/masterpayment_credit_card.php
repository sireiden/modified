 ...
 * ----------------------------------------------------
 *
 * $Id: masterpayment_credit_card.php 12439 2019-12-02 17:40:51Z GTB $
 *	
 *	The Modul based on:
...
require_once(DIR_FS_CATALOG . 'includes/external/masterpayment/MasterpaymentActions.class.php');
  ...
  class masterpayment_credit_card extends MasterpaymentActions {
    ...
    function __construct() {
      ...
      $this->sort_order = ((defined('MODULE_PAYMENT_MASTERPAYMENT_CREDIT_CARD_SORT_ORDER')) ? MODULE_PAYMENT_MASTERPAYMENT_CREDIT_CARD_SORT_ORDER : '');
      $this->enabled = ((defined('MODULE_PAYMENT_MASTERPAYMENT_CREDIT_CARD_STATUS') && MODULE_PAYMENT_MASTERPAYMENT_CREDIT_CARD_STATUS == 'True') ? true : false);
