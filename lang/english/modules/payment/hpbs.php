...
define($prefix.'TEXT_TITLE', 'BillSafe');
define($prefix.'TEXT_DESC', 'BillSafe over Heidelberger Payment GmbH');
...
define($prefix.'INFO', 'Buy with invoice and check<br/>your order calmly before payment.<br/>');
define($prefix.'LEGALNOTE_BILLSAFE', 'Please remit the outstanding amount {DAYS} days after you have been notified about shipping.');
define($prefix.'SUCCESS_BILLSAFE', 'Your transaction was successfull! 
