<?php
  /* --------------------------------------------------------------
   $Id: column_left.php 12335 2019-10-30 06:46:45Z GTB $
...
echo mainMenue(BOX_HEADING_PRODUCTS);
    ...
    if ($admin_access['main_promotions'] == '1') echo '<li><a href="' . xtc_href_link(FILENAME_MAIN_PROMOTIONS, '', 'NONSSL') . '" class="menuBoxContentLink"> -Aktionen</a></li>';
    ...
    if ($admin_access['csv_prices'] == '1') echo '<li><a href="' . xtc_href_link(FILENAME_CSV_PRICES, '', 'NONSSL') . '" class="menuBoxContentLink"> -Preis Update</a></li>';
    ...
    if ($admin_access['transfer_product_attachments'] == '1') echo '<li><a href="' . xtc_href_link(FILENAME_TRANSFER_PRODUCT_ATTACHMENTS, '', 'NONSSL') . '" class="menuBoxContentLink"> -Zubehörartikel kopieren</a></li>';
    if ($admin_access['products_quick_list'] == '1') echo '<li><a href="' . xtc_href_link(FILENAME_PRODUCTS_QUICK_LIST, '', 'NONSSL') . '" class="menuBoxContentLink"> -Schnellbearbeitung von Artikeln</a></li>';
    if ($admin_access['megamenu'] == '1') echo '<li><a href="' . xtc_href_link(FILENAME_MEGAMENU, '', 'NONSSL') . '" class="menuBoxContentLink"> -Megamenü</a></li>';
...
echo mainMenue(BOX_HEADING_PARTNER_MODULES);
    ...
    if (isset($admin_access['configuration']) && $admin_access['configuration'] == '1') echo '<li><a href="' . xtc_href_link(FILENAME_CONFIGURATION, 'gID=910', '') . '" class="menuBoxContentLink"> -'.BOX_CONFIGURATION_910.'</a></li>';
    ## PayPal
...
echo mainMenue(BOX_HEADING_TOOLS);
    ...
    if ($admin_access['lexikon'] == '1') echo '<li><a href="' . xtc_href_link(FILENAME_MODULE_LEXIKON) . '" class="menuBoxContentLink"> -' . BOX_MODULE_LEXIKON . '</a></li>';
...
//---------------------------CSV-Dateien
echo mainMenue('CSV Importe / Exporte');
if ($admin_access['csv_orders'] == '1') echo '<li><a href="' . xtc_href_link(FILENAME_CSV_ORDERS, '', 'NONSSL') . '" class="menuBoxContentLink"> -CSV Aufträge</a></li>';
if ($admin_access['csv_orders'] == '1') echo '<li><a href="' . xtc_href_link(FILENAME_CSV_ORDERS, 'mode=kuechen', 'NONSSL') . '" class="menuBoxContentLink"> -CSV Aufträge (Küchenstudio)</a></li>';
if ($admin_access['csv_billing'] == '1') echo '<li><a href="' . xtc_href_link(FILENAME_CSV_BILLING, '', 'NONSSL') . '" class="menuBoxContentLink"> -CSV Buchhaltung</a></li>';
if ($admin_access['csv_countryorders'] == '1') echo '<li><a href="' . xtc_href_link(FILENAME_CSV_COUNTRYORDERS, '', 'NONSSL') . '" class="menuBoxContentLink"> -CSV Umsatz nach Ländern</a></li>';
if ($admin_access['csv_metatags'] == '1') echo '<li><a href="' . xtc_href_link(FILENAME_CSV_METATAGS, '', 'NONSSL') . '" class="menuBoxContentLink"> -CSV Metatags</a></li>';
if ($admin_access['csv_shippinginfo'] == '1') echo '<li><a href="' . xtc_href_link(FILENAME_CSV_SHIPPINGINFO, '', 'NONSSL') . '" class="menuBoxContentLink"> -CSV Versandkommentare</a></li>';
if ($admin_access['csv_preisanalyse'] == '1') echo '<li><a href="' . xtc_href_link(FILENAME_CSV_PREISANALYSE, '', 'NONSSL') . '" class="menuBoxContentLink"> -CSV Preisanalyse</a></li>';
if ($admin_access['csv_yield'] == '1') echo '<li><a href="' . xtc_href_link(FILENAME_CSV_YIELD, '', 'NONSSL') . '" class="menuBoxContentLink"> -CSV Rendite</a></li>';
if ($admin_access['csv_products'] == '1') echo '<li><a href="' . xtc_href_link(FILENAME_CSV_PRODUCTS, '', 'NONSSL') . '" class="menuBoxContentLink"> -CSV Artikel</a></li>';
if ($admin_access['csv_maschinenversicherung'] == '1') echo '<li><a href="' . xtc_href_link(FILENAME_CSV_MASCHINENVERSICHERUNG, '', 'NONSSL') . '" class="menuBoxContentLink"> -CSV Maschinenversicherung</a></li>';
echo endMenue('CSV Importe / Exporte');
