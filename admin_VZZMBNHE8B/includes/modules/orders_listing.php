<?php
 /*-------------------------------------------------------------
   $Id: orders_listing.php 12206 2019-09-28 08:12:22Z GTB $
            ...
            <td class="boxCenterLeft">
              ...
              <table class="tableBoxCenter collapse">
                ...
                <tr <?php echo $tr_attributes;?>>
                  ...
                  <td class="dataTableContent" align="right"><?php echo $orders['orders_id'].(($orders['customers_status'] == 5) ? '-'.$orders['kvnummer'] : ''); ?></td>                  
                ...
                switch ($action) {
                  ...
                  default :
                    if (isset($oInfo) && is_object($oInfo)) {
                        $heading[] = array ('text' => '<b>['.$oInfo->orders_id.(($oInfo->customers_status == 5) ? '-'.$oInfo->kvnummer : '').']&nbsp;&nbsp;'.xtc_datetime_short($oInfo->date_purchased).'</b>');
