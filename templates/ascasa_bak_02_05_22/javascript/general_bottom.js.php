<?php
/*-----------------------------------------------------------
   $Id: general_bottom.js.php 11096 2018-03-17 07:34:33Z Markus $
...
<script type="text/javascript">
  ...
  $(document).ready(function(){
    ...
    $('.bxcarousel_main_promotions').bxSlider({
        nextText: '<i class="fa fa-chevron-right"></i>',
        prevText: '<i class="fa fa-chevron-left"></i>',
        adaptiveHeight: false,
        mode: 'fade',
    ...
    $('.bxcarousel_manufacturers_slider').bxSlider({
			minSlides: 6, 
			maxSlides: 6,
			slideWidth: 150,
			slideMargin: 20,
...
<?php /* BOF Zusatzbereich für Direktsprung auf das Energielabel */ ?>
<script type="text/javascript">
$(document).ready(function () {
    $( "#eeklasse" ).click(function() {
      $('#ee_tab').trigger('click');  
      $('html, body').animate({ scrollTop: $('#ee_tab').offset().top}, 200);
      $( "#scrollback" ).show();
    });

    $( "#product_datasheet" ).click(function() {
        $('#datenblatt_tab').trigger('click');  
        $('html, body').animate({ scrollTop: $('#datenblatt_tab').offset().top}, 200);
        $( "#scrollback" ).show();
      });

    $( "#scrollback" ).click(function() {
    	$('html, body').animate({ scrollTop: $('#breadcrumb').offset().top}, 200);
    	$( "#scrollback" ).hide();
    });
});
</script>
